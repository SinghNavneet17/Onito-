...
public class GlobalExceptionHandler {
	...
	MyErrorDetails err=new MyErrorDetails(LocalDateTime.now(),"Validation Error",me.getBindingResult().getFieldError().getDefaultMessage());
		...
		public ResponseEntity<MyErrorDetails> moviesExpHandler(MoviesException ie,WebRequest req){
		...
		public ResponseEntity<MyErrorDetails> RatingExpHandler(RatingException ie,WebRequest req){
